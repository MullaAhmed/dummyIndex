...
- **Decided docstring attachment happens once at load, lowest-rationale-id-wins** because query-time answers must be deterministic and cheap; the side table costs one pass over the links (`load.py:83,98-113`).
