# dummyindex session-memory subsystem — Implementation Plan
...
> **Run all commands from the repo root** `/mnt/windows-ssd/Projects/memory/graphify`. Tests run with `uv run pytest`.
