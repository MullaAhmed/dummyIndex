"""Tests for dummyindex/security.py - URL validation, safe fetch, path guards, label sanitisation."""
...
from dummyindex.runtime.security import (
    sanitize_label,
    safe_fetch,
    safe_fetch_text,
    validate_graph_path,
...
def test_safe_fetch_returns_bytes(tmp_path):
    ...
    with patch("dummyindex.runtime.security._build_opener") as mock_opener_fn:
