"""Frozen `LanguageConfig` instances, one per generic-extractor language.

These tie a tree-sitter grammar module to the set of node types the
generic walker should recognise as classes / functions / imports / calls
