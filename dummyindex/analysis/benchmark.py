"""Token-reduction benchmark - measures how much context dummyindex saves vs naive full-corpus approach."""
...
def run_benchmark(
    graph_path: str = "dummyindex-out/graph.json",
    corpus_words: int | None = None,
    questions: list[str] | None = None,
) -> dict:
    """Measure token reduction: corpus tokens vs dummyindex query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\ndummyindex token reduction benchmark")
    print(f"{'─' * 50}")
