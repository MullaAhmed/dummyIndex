...
def _community_article(
    ...
    lines += ["---", "", "*Part of the dummyindex knowledge wiki. See [[index]] to navigate.*"]
    return "\n".join(lines)
...
def _index_md(
    ...
    lines: list[str] = [
        ...
        "",
        "> Auto-generated by dummyindex. Start here — read community articles for context, then drill into god nodes for detail.",
        "",
    ...
    lines += [
        "---",
        "",
        "*Generated by [dummyindex](https://github.com/MullaAhmed/dummyindex)*",
    ]
    return "\n".join(lines)
