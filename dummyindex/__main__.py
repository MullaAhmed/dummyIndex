...
def _print_help() -> None:
    ...
    print()
    print("  ingest [path]             index <path> into <path>/.context/ + update CLAUDE.md")
    print("                            (alias for `context init`; default path: cwd)")
    print()
    print("  context init [path]       same as `ingest`")
    print("  context rebuild [--changed] [path]")
    print("                            rebuild .context/ (use --changed for incremental)")
    print("  context bootstrap [path]  regenerate the CLAUDE.md managed block only")
    print("  context enrich-plan [path]")
    print("                            emit .context/_enrich_plan.json — work-list for the")
    print("                            /dummyindex skill's semantic enrichment pass")
    print("  context enrich-apply [path] --from-json FILE")
