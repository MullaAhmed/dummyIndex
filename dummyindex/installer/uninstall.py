    ...
    *,
    ...
    for host in concrete_platforms:
        ...
        if skill_dir.is_symlink():
            ...
            # Remove every companion markdown installed alongside.  A
            # companion directory may itself have been replaced by a symlink;
            # unlink that leaf without reading or modifying its target.
