...
- [03 — Architecture](docs/brief/03-architecture.md) — the four layers + the auto-refresh loop
- [04 — `.context/` data model](docs/brief/04-data-model.md) — what gets generated, where
- [05 — Multi-agent council](docs/brief/05-council.md) — the deep-dive pattern
- [06 — Personas](docs/brief/06-personas.md) — the five agents
...
- Language-agnostic: tree-sitter for ~20 languages; LLM-driven extraction for the rest.
- Two enrichment passes: deterministic Python builds the skeleton; specialist agents fill it with judgment.
- Five personas (architect, senior dev, DBA, security analyst, PM) work the codebase like a real team.
...
- [graphify](https://github.com/safishamsi/graphify) — this project's deterministic-graph heritage.
