...
def __getattr__(name):
    ...
    _map = {
        ...
        "build_structure": ("graphify.pipeline.structure", "build_structure"),
        ...
        "to_structure_json": ("graphify.pipeline.export", "to_structure_json"),
        "to_html": ("graphify.pipeline.export", "to_html"),
        "to_structure_html": ("graphify.pipeline.export", "to_structure_html"),
